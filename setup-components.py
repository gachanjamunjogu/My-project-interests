...
components_dir = os.path.join('client', 'src', 'components')
os.makedirs(components_dir, exist_ok=True)
print(f"Created directory: {components_dir}")

# Create TaskCard.tsx
task_card_content = '''import { ReactNode } from "react"
...
with open(os.path.join(components_dir, 'TaskCard.tsx'), 'w') as f:
    f.write(task_card_content)
print('Created: client/src/components/TaskCard.tsx')

# Create TaskColumn.tsx  
task_column_content = '''import { Task, TaskStatus, TaskCard } from "./TaskCard"
...
with open(os.path.join(components_dir, 'TaskColumn.tsx'), 'w') as f:
    f.write(task_column_content)
print('Created: client/src/components/TaskColumn.tsx')

# Create TaskBoard.tsx
task_board_content = '''import { useMemo } from "react"
...
with open(os.path.join(components_dir, 'TaskBoard.tsx'), 'w') as f:
    f.write(task_board_content)
print('Created: client/src/components/TaskBoard.tsx')
