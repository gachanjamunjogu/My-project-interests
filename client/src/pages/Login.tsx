    ...
    <div className="mx-auto max-w-md px-4 py-12">
      <div className="rounded-[2rem] border border-[#D4AF37]/20 bg-[#0B0B0B]/80 p-8 shadow-aura">
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-base text-white/60">Log in to access your productivity cockpit.</p>
        </div>
        ...
        <p className="mt-6 text-center text-base text-white/60">
          New to AURA?{' '}
          <Link to="/register" className="font-semibold text-[#D4AF37] hover:text-[#C5A021]">
            Create an account
          </Link>
        </p>
      </div>
