...
# Component Setup Script for AURA Task Manager
# This script creates the reusable React components extracted from Dashboard.tsx

# Create the components directory
mkdir -p client/src/components

# Create TaskCard.tsx
cat > client/src/components/TaskCard.tsx << 'EOF'
...
cat > client/src/components/TaskColumn.tsx << 'EOF'
...
echo "✓ Created client/src/components/TaskColumn.tsx"

# Create TaskBoard.tsx
cat > client/src/components/TaskBoard.tsx << 'EOF'
...
echo "✓ Created client/src/components/TaskBoard.tsx"
